...
def get_data():
    ...
    data = pd.read_csv("df_filtered50.csv")
...
logo = Image.open('joia_logo.png')
st.image(logo,width=300, use_column_width=False )
st.title("Recherche des Produits Tendances par Catégorie")
